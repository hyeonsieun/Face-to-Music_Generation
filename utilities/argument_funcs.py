...
def parse_eval_args():
    ...
    parser.add_argument("-dataset_dir", type=str, default="./dataset", help="Folder of preprocessed and pickled midi files")
...
def parse_generate_args():
    ...
    parser.add_argument("-midi_root", type=str, default="./dataset", help="Midi file to prime the generator with")
